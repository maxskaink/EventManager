...
export function LoginScreen() {
  ...
  const handleGuestLogin = () => {
    login('guest@semillero.com', 'guest');
  };
        ...
        <CardContent className="space-y-4">
          ...
          <div className="mt-6 p-3 bg-muted rounded-lg">
            ...
            <div className="space-y-1 text-xs">
              <p><strong>Integrante:</strong> member@test.com / 123</p>
              <p><strong>Coordinador:</strong> coordinator@test.com / 123</p>
              <p><strong>Mentor:</strong> mentor@test.com / 123</p>
            </div>
          </div>
        </CardContent>
      </Card>
