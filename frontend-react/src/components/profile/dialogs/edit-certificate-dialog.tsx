...
export const EditCertificateDialog = ({ open, onOpenChange, onEditCertificate, isPending = false, certificate }: EditCertificateDialogProps) => {
    const {
        register,
        handleSubmit,
        control,
            ...
            <DialogContent className="sm:max-w-lg max-h-[90vh] overflow-y-auto p-4 sm:p-6">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="edit-cert-no-expire" className="text-sm font-normal cursor-pointer">
